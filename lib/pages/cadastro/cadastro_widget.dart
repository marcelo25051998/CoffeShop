                  ...
                  children: [
                    Align(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          'https://images.unsplash.com/photo-1595574444306-e235cef5ea37?crop=entropy&cs=srgb&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxN3x8Q09GRkV8ZW58MHx8fHwxNzAxNTcyNzAxfDA&ixlib=rb-4.0.3&q=85',
                          width: 1441.0,
                          height: 321.0,
                          fit: BoxFit.cover,
                        ),
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: Text('Aceito'),
                                          content: Text(
                                              'verifique a caixa de email para ativar a conta'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
